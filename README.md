...
* [Splink](https://github.com/moj-analytical-services/splink) ⭐ 2,390 | 🐛 207 | 🌐 Python | 📅 2026-09-09 (Python, SQL, Spark) - Scalable Fellegi-Sunter and rule-based entity resolution using your choice of SQL or Spark backend.
* [Zingg](https://github.com/zinggAI/zingg) ⭐ 1,244 | 🐛 92 | 🌐 Java | 📅 2026-09-04 (Python, Java) - Scalable, active learning model for entity resolution.
...
* [FaceNet-PyTorch](https://github.com/timesler/facenet-pytorch) ⭐ 5,166 | 🐛 85 | 🌐 Python | 📅 2025-09-16 (Python, PyTorch) - Embeddings for facial identity resolution.
...
* [python-nameparser](https://github.com/derek73/python-nameparser) ⭐ 715 | 🐛 24 | 🌐 Python | 📅 2026-09-08 (Python) - Separate names into individual components.
...
* [ElasticSearch](https://github.com/elastic/elasticsearch) ⭐ 77,900 | 🐛 6,058 | 🌐 Java | 📅 2026-09-09 - Search text.
