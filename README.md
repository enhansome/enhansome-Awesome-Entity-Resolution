...
* [dedupe](https://github.com/dedupeio/dedupe) ⭐ 4,511 | 🐛 92 | 🌐 Python | 📅 2025-07-29 (Python) - Active learning and flexible Python tooling for entity resolution.
* [Splink](https://github.com/moj-analytical-services/splink) ⭐ 2,406 | 🐛 211 | 🌐 Python | 📅 2026-09-11 (Python, SQL, Spark) - Scalable Fellegi-Sunter and rule-based entity resolution using your choice of SQL or Spark backend.
* [Zingg](https://github.com/zinggAI/zingg) ⭐ 1,247 | 🐛 92 | 🌐 Java | 📅 2026-09-13 (Python, Java) - Scalable, active learning model for entity resolution.
...
* [jellyfish](https://github.com/jamesturk/jellyfish) ⭐ 2,233 | 🐛 7 | 🌐 Jupyter Notebook | 📅 2026-07-24 (Python, C) - Fast string distance and phonetic matching.
...
* [libpostal](https://github.com/openvenues/libpostal) ⭐ 4,886 | 🐛 299 | 🌐 C | 📅 2026-05-13 (C, and bindings for Python, Java, Go, Ruby, PHP, and NodeJS) - Multinational address parsing.
* [Ftfy](https://github.com/rspeer/python-ftfy) ⭐ 4,063 | 🐛 25 | 🌐 Python | 📅 2024-10-30 (Python) - Fixes text (unicode artifacts) for you.
* [python-nameparser](https://github.com/derek73/python-nameparser) ⭐ 715 | 🐛 20 | 🌐 Python | 📅 2026-09-14 (Python) - Separate names into individual components.
...
* [ElasticSearch](https://github.com/elastic/elasticsearch) ⭐ 77,912 | 🐛 6,062 | 🌐 Java | 📅 2026-09-14 - Search text.
