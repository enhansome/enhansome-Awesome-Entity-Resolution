...
* [dedupe](https://github.com/dedupeio/dedupe) ⭐ 4,513 | 🐛 92 | 🌐 Python | 📅 2025-07-29 (Python) - Active learning and flexible Python tooling for entity resolution.
* [Splink](https://github.com/moj-analytical-services/splink) ⭐ 2,418 | 🐛 212 | 🌐 Python | 📅 2026-09-19 (Python, SQL, Spark) - Scalable Fellegi-Sunter and rule-based entity resolution using your choice of SQL or Spark backend.
* [Zingg](https://github.com/zinggAI/zingg) ⭐ 1,249 | 🐛 109 | 🌐 Java | 📅 2026-09-13 (Python, Java) - Scalable, active learning model for entity resolution.
...
* [FaceNet-PyTorch](https://github.com/timesler/facenet-pytorch) ⭐ 5,168 | 🐛 85 | 🌐 Python | 📅 2025-09-16 (Python, PyTorch) - Embeddings for facial identity resolution.
...
* [python-nameparser](https://github.com/derek73/python-nameparser) ⭐ 715 | 🐛 18 | 🌐 Python | 📅 2026-09-20 (Python) - Separate names into individual components.
...
* [ElasticSearch](https://github.com/elastic/elasticsearch) ⭐ 77,952 | 🐛 6,104 | 🌐 Java | 📅 2026-09-21 - Search text.
