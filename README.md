...
* [Splink](https://github.com/moj-analytical-services/splink) ⭐ 2,384 | 🐛 210 | 🌐 Python | 📅 2026-09-04 (Python, SQL, Spark) - Scalable Fellegi-Sunter and rule-based entity resolution using your choice of SQL or Spark backend.
...
* [textdistance](https://github.com/life4/textdistance) ⭐ 3,539 | 🐛 11 | 🌐 Python | 📅 2025-04-18 (Python) - Very large collection of sequence comparison functions, including token-based distances.
...
* [FaceNet-PyTorch](https://github.com/timesler/facenet-pytorch) ⭐ 5,165 | 🐛 85 | 🌐 Python | 📅 2025-09-16 (Python, PyTorch) - Embeddings for facial identity resolution.
...
* [python-nameparser](https://github.com/derek73/python-nameparser) ⭐ 715 | 🐛 32 | 🌐 Python | 📅 2026-09-06 (Python) - Separate names into individual components.
...
* [ElasticSearch](https://github.com/elastic/elasticsearch) ⭐ 77,902 | 🐛 6,041 | 🌐 Java | 📅 2026-09-06 - Search text.
