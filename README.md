...
* [dedupe](https://github.com/dedupeio/dedupe) ⭐ 4,512 | 🐛 92 | 🌐 Python | 📅 2025-07-29 (Python) - Active learning and flexible Python tooling for entity resolution.
* [Splink](https://github.com/moj-analytical-services/splink) ⭐ 2,416 | 🐛 212 | 🌐 Python | 📅 2026-09-19 (Python, SQL, Spark) - Scalable Fellegi-Sunter and rule-based entity resolution using your choice of SQL or Spark backend.
* [Zingg](https://github.com/zinggAI/zingg) ⭐ 1,249 | 🐛 108 | 🌐 Java | 📅 2026-09-13 (Python, Java) - Scalable, active learning model for entity resolution.
...
* [textdistance](https://github.com/life4/textdistance) ⭐ 3,539 | 🐛 10 | 🌐 Python | 📅 2025-04-18 (Python) - Very large collection of sequence comparison functions, including token-based distances.
* [jellyfish](https://github.com/jamesturk/jellyfish) ⭐ 2,232 | 🐛 8 | 🌐 Jupyter Notebook | 📅 2026-07-24 (Python, C) - Fast string distance and phonetic matching.
...
* [FaceNet-PyTorch](https://github.com/timesler/facenet-pytorch) ⭐ 5,169 | 🐛 85 | 🌐 Python | 📅 2025-09-16 (Python, PyTorch) - Embeddings for facial identity resolution.
* [Entity Embed](https://github.com/vintasoftware/entity-embed) ⭐ 162 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2022-11-18 (Python, PyTorch) - Pytorch text embedding model for blocking.

### Data Cleaning and Parsing

* [libpostal](https://github.com/openvenues/libpostal) ⭐ 4,891 | 🐛 299 | 🌐 C | 📅 2026-05-13 (C, and bindings for Python, Java, Go, Ruby, PHP, and NodeJS) - Multinational address parsing.
* [Ftfy](https://github.com/rspeer/python-ftfy) ⭐ 4,064 | 🐛 26 | 🌐 Python | 📅 2024-10-30 (Python) - Fixes text (unicode artifacts) for you.
* [python-nameparser](https://github.com/derek73/python-nameparser) ⭐ 715 | 🐛 17 | 🌐 Python | 📅 2026-09-20 (Python) - Separate names into individual components.
...
* [ElasticSearch](https://github.com/elastic/elasticsearch) ⭐ 77,941 | 🐛 6,098 | 🌐 Java | 📅 2026-09-20 - Search text.
...
* [Delex](https://github.com/anhaidgroup/delex) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2026-08-29 (Spark, Python) - Open-source tool for blocking rules.
